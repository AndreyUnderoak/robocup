...
class Arm_kinematics{
    public:
        ...
        std::vector<double>             inverse(Matrix<double, 3, 3> r05, std::vector<double> coordinates, uint8_t conf_t_1, uint8_t conf_t_3, double ee_y_orientation, double ee_z_orientation);
        ...
        // General inverse AN
        std::vector<double>  inverse_AN(Matrix<double, 4, 4> T, std::vector<double> theta_array_goal, uint8_t conf_t_1, uint8_t conf_t_3);
        // SASHA FUNCTIONS
        std::vector<double>  inverse_1(Matrix<double, 3, 3> r05, std::vector<double> coors, uint8_t conf_t_1, uint8_t conf_t_3);
        ...
        Matrix<double, 3, 3> get_r(Matrix<double, 4, 4> T);
        Matrix<double, 3, 1> get_z5(Matrix<double, 3, 3> r, double theta_1);
        double               theta_1_s(double x, double y, uint8_t conf_t_1);
        std::vector<double>  theta_23_s(Matrix<double, 3, 3> r, std::vector<double> p, double theta_1, uint8_t conf_t_3);
